...
function NLThemeShortCodeManager(themeContext,shortcode)
{	
	this.mode='enter';
...
NLThemeShortCodeManager.prototype.register=function()
{	
	tinymce.PluginManager.add('shortcode_manager',function(editor,url) 
	{
		editor.addButton('shortcode_manager_button', 
		{
			...
			onclick		:	function() 
			{
				...
				tb_show('',url+'/../template/admin/shortcode_manager.php?shortcode='+shortcode+'&TB_iframe=true&width=800&height=600');
...
NLThemeShortCodeManager.prototype.create=function()
{		
	var self=this;
...
NLThemeShortCodeManager.prototype.setShortCode=function(data)
{
...
NLThemeShortCodeManager.prototype.calculateDimension=function()
{
...
NLThemeShortCodeManager.prototype.calculateDimensionTime=function(self)
{
...
NLThemeShortCodeManager.prototype.createShortCode=function()
{
